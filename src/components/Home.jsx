      ...
      <div className="flex-1 text-center ml-4">
        ...
        <div className="flex justify-center gap-6 mt-6 flex-wrap">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center justify-center px-1 py-1 border border-transparent text-base font-medium rounded-md shadow-sm bg-blue-700 !text-white"
          >
            Resume
          </a>
        </div>
